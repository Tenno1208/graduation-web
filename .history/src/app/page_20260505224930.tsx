...
import { Volume2, VolumeX } from "lucide-react"; // Install lucide-react dulu: npm install lucide-react
    ...
    <main className="bg-black text-white selection:bg-yellow-500 selection:text-black">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="mt-4 tracking-[0.8em] text-yellow-500 uppercase text-xs md:text-sm">SMK Class of 2026</p>
        </div>
      </section>
