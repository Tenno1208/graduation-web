...
export default function LandingGate({ onEnter }: LandingGateProps) {
  ...
  return (
    ...
    >
      ...
      {/* ─── FULLSCREEN BACKGROUND ADJUSTMENT ─── */}
<div className="absolute inset-0 z-0">
  <Image
    src="/images/foto_bareng_kelas.jpg" 
    alt="Foto Bersama XII TKJ 2"
    fill
    className="object-cover transition-transform duration-[15s] ease-out"
    style={{ 
      // objectPosition: "top" agar wajah yang di atas tidak terpotong
      objectPosition: "50% 20%", 
      filter: "brightness(0.35) saturate(0.9) contrast(1.1)",
      transform: phase === "ready" ? "scale(1.15)" : "scale(1.05)" 
    }}
    priority
  />
  {/* Gradasi lebih gelap di bawah agar teks putih "menyala" */}
